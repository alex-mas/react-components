...
class AutoComplete extends react_1.default.Component {
    ...
    shouldAddSuggestion(value, suggestion, suggestions) {
        return suggestion.substring(0, value.length) === value && suggestions.indexOf(suggestion) === -1 && value !== suggestion;
    }
    ...
    render() {
        ...
        return react_1.default.createElement("div", { className: this.props.className ? this.props.className : undefined, onKeyDown: this.onKeyDown }, react_1.default.createElement("div", { className: 'auto-complete', style: this.state.styles.autoComplete }, react_1.default.createElement("input", { id: this.state.id, className: 'auto-complete__input', placeholder: this.props.placeholder, type: 'text', value: value, onChange: this.onChange, onBlur: this.onBlur, onFocus: this.onFocus, style: this.state.styles.autoComplete__input }), this.state.focused ? react_1.default.createElement("div", { className: 'auto-complete__suggestions', style: this.state.styles.autoComplete__suggestions }, this.state.suggestions.map((suggestion, index) => {
            const selected = index === this.state.selectedSuggestion;
            let className = 'auto-complete__suggestion';
            if (selected) {
                className += '--selected';
            }
            return react_1.default.createElement("div", { key: suggestion, className: className, style: selected ? this.state.styles.autoComplete__suggestion_selected : this.state.styles.autoComplete__suggestion }, suggestion);
        })) : undefined));
    }
}
...
var _autoComplete = __webpack_require__(/*! ../../../dist/autoComplete */ "../dist/autoComplete.js");
